    ...
    <div style="text-align: -webkit-center;text-align: -moz-center;text-align: -webkit-center;">
      ...
      <div style="text-align: -moz-center;text-align: -webkit-center; margin-top:20px;margin-bottom:20px;   border-radius: 20px;">
        <div class=" backgroundText" style="text-align: -moz-center;text-align: -webkit-center;border-radius: 20px;">
          ...
          We advise, design and implement solutions for electricity, structured cabling, security systems, air conditioning and automation.
        </div>
      </div>


      <span class="mainTitleTextFirst" style="color: black;">Modular Technology
      </span>
      <span class="mainTitleTextSecond" style="color: black;">SERVICE
      </span>
        ...
        <div class="row">
          <div class="col-lg-6 col-md-6">
            <div class="card">
              ...
              <div style="text-align: -webkit-center;text-align: -moz-center;text-align: -webkit-center;">
                <span class="titleCard">Structured</span>
                <span class="titleCard">Cabling</span>
                <div class="lineTec">
                </div>
              </div>
          ...
          <div class="col-lg-6 col-md-6 cardDerecha">
            <div class="card">
              ...
              <div style="text-align: -webkit-center;text-align: -moz-center;text-align: -webkit-center;">
                <span class="titleCard">Surveillance</span>
                <span class="titleCard">Systems</span>
                <div class="lineTec">
                </div>
              </div>
          ...
          <div class="col-lg-6 col-md-6 cardIzquierda">
            <div class="card">
              ...
              <div style="text-align: -webkit-center;text-align: -moz-center;text-align: -webkit-center;">
                <span class="titleCard">Electricity
                </span>
                <div class="lineTec">
                </div>
              </div>
          ...
          <div class="col-lg-6 col-md-6 cardDerecha">
            <div class="card">
              ...
              <div style="text-align: -webkit-center;text-align: -moz-center;text-align: -webkit-center;">
                <span class="titleCard">Climate
                </span>
                <span class="titleCard" style="font-size: 15px;margin-top:16px">(AIR CONDITIONING)
                </span>
          ...
          <div class="col-lg-6 col-md-6 cardIzquierda">
            <div class="card">
              ...
              <div style="text-align: -webkit-center;text-align: -moz-center;text-align: -webkit-center;">
                <span class="titleCard">Lighting and Home Automation
                </span>
          ...
          <div class="col-lg-6 col-md-6 cardDerecha">
            <div class="card">
              ...
              <div style="text-align: -webkit-center;text-align: -moz-center;text-align: -webkit-center;">
                <span class="titleCard">Consulting and Design
                </span>
                <div class="lineTec">
                </div>
              </div>
      ...
      <div style="position: relative;margin-top: 155px;">
        <span class="titleTec">
          THE BEST TECHNOLOGICAL SYSTEMS
        </span>
        <span class="titleTec">
