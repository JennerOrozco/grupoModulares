...
<head>
  <title>Grupo Modular - Inicio</title>
  <meta charset="utf-8">
...
<body>
  <div id="showPC" class="hidden" style="height: 100vh">
    ...
    <div style="margin-left: 80px;    display: block;margin-bottom: 10px;">
      ...
      <a href="./mobiliario.php" class="showLine2">
        <h3>mobiliario</h3>
      </a>
      <a href="./tecnologia.php" class="showLine3">
        <h3>tecnología</h3>
      </a>
      <br>
      <a href="./portafolio.php" class="showLine4">
        <h3>portafolio</h3>
      </a>
      <a href="./mas.php" class="showLine5">
