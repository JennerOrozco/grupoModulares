...
$header = str_replace("titlePage", "Grupo Modulares - Portfolio", $header);
...
$header = str_replace("mainTitleTexto", "portfolio", $header);
    ...
    <div style="text-align: -webkit-center;text-align: -moz-center;text-align: -webkit-center;">
      ...
      <section class="section bg-default section-sm">
        <div class="container">
          ...
          <span class="mainTitleTextFirst">Portfolio
          </span>
          <span class="mainTitleTextSecond">WORLD CLASS PROJECTS
          </span>
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-6">
          <a class="grid-gallery__item" href="./en-portafolioDescripcion.php?data=12">
