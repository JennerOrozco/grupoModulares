...
$header = str_replace("titlePage", "Grupo Modulares - Architecture", $header);
...
$header = str_replace("mainTitleTexto", "architecture", $header);
    ...
    <div style="text-align: -webkit-center;text-align: -moz-center;text-align: -webkit-center;">
        ...
        <div class="container">
              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <div class="box-counter">
                    ...
                    <p class="box-counter-title efecto-espejo">Years of Experience</p>
              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <div class="box-counter">
                    ...
                    <p class="box-counter-title">Fulfilled Projects</p>
                    <p class="box-counter-title efecto-espejo">Fulfilled Projects</p>
                    <div class="box-counter-main efecto-espejo">
          ...
          <div style="text-align: -moz-center;text-align: -webkit-center; margin-top:20px;margin-bottom:20px;   border-radius: 20px;">
            <div class=" backgroundText" style="text-align: -moz-center;text-align: -webkit-center;border-radius: 20px;">
              ...
              We advise, design, build and implement world-class turnkey projects.
            </div>
          </div>

          <span class="mainTitleTextFirst" style="color:#000">Success stories </span><span class="mainTitleTextSecond" style="color:#000">INSPIRING ARCHITECTURE </span>
      ...
      <div class="row">
        <div class="col-lg-4 col-6">
          <a class="grid-gallery__item" href="./en-portafolioDescripcion.php?data=1">
        ...
        <div class="col-lg-4 col-6">
          <a class=" grid-gallery__item" href="./en-portafolioDescripcion.php?data=3">
        ...
        <div class="col-lg-4 col-6">
          <a class="grid-gallery__item" href="./en-portafolioDescripcion.php?data=4">
        ...
        <div class="col-lg-4 col-6">
          <a class="grid-gallery__item" href="./en-portafolioDescripcion.php?data=5">
        ...
        <div class="col-lg-4 col-6">
          <a class="grid-gallery__item" href="./en-portafolioDescripcion.php?data=6">
        ...
        <div class="col-lg-4 col-6">
          <a class="grid-gallery__item" href="./en-portafolioDescripcion.php?data=7">
        ...
        <div class="col-lg-4 col-6">
          <a class="grid-gallery__item" href="./en-portafolioDescripcion.php?data=8">
        ...
        <div class="col-lg-4 col-6">
          <a class="grid-gallery__item" href="./en-portafolioDescripcion.php?data=9">
