...
$header = str_replace("titlePage", "Grupo Modulares - Furniture", $header);
...
$header = str_replace("<!--fotos-->", '<div class="swiper-slide" data-slide-bg="img/bg/11.jpg" style="background-position: center;">                    <div class="swiper-slide-caption section-lg">                        <div class="container">                            <div class="row">                                <div class="col-md-9 col-lg-7 offset-md-1 offset-xxl-0">                                </div>                            </div>                        </div>                    </div>                </div>', $header);
$header = str_replace("<!--fotos1-->", '<div class="swiper-slide" data-slide-bg="img/bg/12.jpg" style="background-position: center;">                    <div class="swiper-slide-caption section-lg">                        <div class="container">                            <div class="row">                                <div class="col-md-9 col-lg-7 offset-md-1 offset-xxl-0">                                </div>                            </div>                        </div>                    </div>                </div>', $header);
$header = str_replace("<!--fotos2-->", '<div class="swiper-slide" data-slide-bg="img/bg/13.jpg" style="background-position: center;">                    <div class="swiper-slide-caption section-lg">                        <div class="container">                            <div class="row">                                <div class="col-md-9 col-lg-7 offset-md-1 offset-xxl-0">                                </div>                            </div>                        </div>                    </div>                </div>', $header);
$header = str_replace("<!--fotos3-->", '<div class="swiper-slide" data-slide-bg="img/bg/14.jpg" style="background-position: center;">                    <div class="swiper-slide-caption section-lg">                        <div class="container">                            <div class="row">                                <div class="col-md-9 col-lg-7 offset-md-1 offset-xxl-0">                                </div>                            </div>                        </div>                    </div>                </div>', $header);
$header = str_replace("<!--fotos4-->", '<div class="swiper-slide" data-slide-bg="img/bg/15.jpg" style="background-position: center;">                    <div class="swiper-slide-caption section-lg">                        <div class="container">                            <div class="row">                                <div class="col-md-9 col-lg-7 offset-md-1 offset-xxl-0">                                </div>                            </div>                        </div>                    </div>                </div>', $header);



$header = str_replace("mainTitleTexto", "Furniture", $header);
    ...
    <div style="text-align: -webkit-center;text-align: -moz-center;text-align: -webkit-center;">
      ...
      <div style="text-align: -moz-center;text-align: -webkit-center; margin-top:20px;margin-bottom:20px;   border-radius: 20px;">
        <div class=" backgroundText" style="text-align: -moz-center;text-align: -webkit-center;border-radius: 20px;">
          <h3 style=" margin-bottom: 10px;color: black;">What's our job?</h3>
          <div style="margin-bottom: 20px;font-size:19px" class="lineMainTitleTextSecond"></div>
          We advise, design, manufacture, and install furniture for offices and call centers.
        </div>
      </div>
      ...
      <div style="margin-top: 80px;">
            ...
            <div class="row" style="margin-top: 10px;">
              <div class="col-4">
                ...
                <div class="box-counter">
                  <p class="box-counter-title">Square meters of the factory </p>
              ...
              <div class="col-4">
                <!--Box counter-->
                <div class="box-counter">
                  <p class="box-counter-title">Employees</p>
                  <div class="box-counter-main" style="margin-top: 0px;">
        ...
        <span class="mainTitleTextFirst" style="color: black;">Our products
        </span>
        <span class="mainTitleTextSecond" style="color: black;">A UNIVERSE OF PRODUCTIVE SOLUTIONS
        </span>
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="card">
                ...
                <div style="text-align: -webkit-center;text-align: -moz-center;text-align: -webkit-center;">
                  <span class="titleCard">Filing</span>
                  <span class="titleCard">Cabinets</span>
                  <div class="lineTec"></div>
                </div>
                <a href="./en-mobiliarioDescripcion.php?data=3"><img class="imgOjo" src="img/utilidad/cards/ojo.png" alt=""></a>
              </div>
            </div>
            ...
            <div class="col-lg-6">
              <div class="card">
                ...
                <div style="text-align: -webkit-center;text-align: -moz-center;text-align: -webkit-center;">
                  <span class="titleCard">Chairs</span>
                  <div class="lineTec"></div>
                </div>
                <a href="./en-mobiliarioDescripcion.php?data=4"><img class="imgOjo" src="img/utilidad/cards/ojo.png" alt=""></a>
              </div>
            </div>
            ...
            <div class="col-lg-6">
              <div class="card">
                ...
                <div style="text-align: -webkit-center;text-align: -moz-center;text-align: -webkit-center;">
                  <span class="titleCard">Folding Partitions</span>
                  <div class="lineTec"></div>
                </div>
                <a href="./en-mobiliarioDescripcion.php?data=5"><img class="imgOjo" src="img/utilidad/cards/ojo.png" alt=""></a>
              </div>
            </div>
            ...
            <div class="col-lg-6">
              <div class="card">
                ...
                <div style="text-align: -webkit-center;text-align: -moz-center;text-align: -webkit-center;">
                  <span class="titleCard">Modular Systems</span>
                  <div class="lineTec"></div>
                </div>
                <a href="./en-mobiliarioDescripcion.php?data=6"><img class="imgOjo" src="img/utilidad/cards/ojo.png" alt=""></a>
              </div>
            </div>
            ...
            <div class="col-lg-6">
              <div class="card" style="padding-top: 70px;">
                ...
                <a href="./en-mobiliarioDescripcion.php?data=7"><img class="imgOjo" src="img/utilidad/cards/ojo.png" alt=""></a>
              </div>
            </div>
            ...
            <div class="col-lg-6">
              <div class="card">
                ...
                <div style="text-align: -webkit-center;text-align: -moz-center;text-align: -webkit-center;">
                  <span class="titleCard">Armchairs and Others</span>
                  <div class="lineTec"></div>
                </div>
                <a href="./en-mobiliarioDescripcion.php?data=8"><img class="imgOjo" src="img/utilidad/cards/ojo.png" alt=""></a>
              </div>
            </div>
            ...
            <div class="col-lg-6">
              <div class="card" style="padding-top: 100px;">
                ...
                <a href="./en-mobiliarioDescripcion.php?data=9"><img class="imgOjo" src="img/utilidad/cards/ojo.png" alt=""></a>
              </div>
            </div>
            ...
            <div class="col-lg-6">
              <div class="card">
                ...
                <div style="text-align: -webkit-center;text-align: -moz-center;text-align: -webkit-center;">
                  <span class="titleCard">Special Furniture</span>
                  <span class="titleCard" style="font-size:20px">MCA</span>
                  <div class="lineTec" style="padding-top: 5px;"></div>
                </div>
                <a href="./en-mobiliarioDescripcion.php?data=10"><img class="imgOjo" src="img/utilidad/cards/ojo.png" alt=""></a>
              </div>
            </div>
            ...
            <div class="col-lg-6">
              <div class="card" style="padding-top: 135px;">
                ...
                <div style="text-align: -webkit-center;text-align: -moz-center;text-align: -webkit-center;">
                  <span class="titleCard">Global from Canada</span>
                  <span class="titleCard" style="font-size:20px">Imported Furniture</span>
                  <div class="lineTec" style="padding-top: 5px;"></div>
                </div>
                <a href="./en-mobiliarioDescripcion.php?data=11"><img class="imgOjo" src="img/utilidad/cards/ojo.png" alt=""></a>
              </div>
            </div>
            ...
            <div class="col-lg-6">
              <div class="card" style="padding-top: 70px;">
                ...
                <div style="text-align: -webkit-center;text-align: -moz-center;text-align: -webkit-center;">
                  <span class="titleCard">Stainless steel</span>
                  <div class="lineTec"></div>
                </div>
                <a href="./en-mobiliarioDescripcion.php?data=12"><img class="imgOjo" src="img/utilidad/cards/ojo.png" alt=""></a>
              </div>
            </div>
