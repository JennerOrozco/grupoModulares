...
$header = str_replace("mainTitleTexto", "tecnologia", $header);
echo $header;
?>
...
<section class="section bg-default section-md">
  <div class="container">
    <div style="text-align: -webkit-center;text-align: -moz-center;text-align: -webkit-center;">
      ...
      <span class="mainTitleTextFirst" style="color:black" id="titulo">
      </span>
      <span class="mainTitleTextSecond" style="color:black" id="titulo2">
      </span>
...
<script>
  ...
  $.getJSON("tecnologia.json", function(data) {
    var bandera = true
    var dato = data.Items
    dato.forEach(element => {
      if (element.id == (getQueryStringValue("data"))) {
        ...
        document.getElementById("titulo2").innerHTML = element.prop.title2
        document.getElementById("texto1").innerHTML = element.prop.text1

        imgObject.push(element.prop.image1)
        imgObject.push(element.prop.image2)
        imgObject.push(element.prop.image3)
